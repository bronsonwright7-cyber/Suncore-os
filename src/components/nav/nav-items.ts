...
import { canManageCore, canReadBroadly, canViewPartners } from "@/lib/permissions";
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/dashboard/intake", label: "AI Intake", icon: ClipboardPaste, visible: canManageCore },
